...
updateProjects(array('macroeconomic-scoreboard'),
  array("1448623066566" => "https://sdw-wsrest.ecb.europa.eu/service/data/EXR/A.H42.ATS+BEF+CYP+DEM+EEK+ESP+FIM+FRF+GRD+IEP+ITL+LTL+LUF+LVL+MTL+NLG+PTE+SIT+SKK.NRC0.T?startPeriod=2000"),
  $upto,
  $force,
  $ConfigEdit);
